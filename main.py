...
if main_menu == 'Summer':
    ...
    if user_menu == 'Medal Tally':
        ...
        medal_tally = helper.fetch_medal_tally(df, selected_year, selected_country, 'Summer')
    ...
    if user_menu == 'Athlete wise Analysis':
        ...
        fig, ax = plt.pyplot.subplots(figsize=(20, 20))
        ax = sns.scatterplot(data=temp_df, x=temp_df['Weight'], y=temp_df['Height'], s=200, hue=temp_df['Medal'],
                             style=temp_df['Sex'])
        st.pyplot(fig)
...
if main_menu == 'Winter':
    ...
    df = preprocessor.winter_process(df, region_df)
    ...
    if user_menu == 'Medal Tally':
        ...
        medal_tally = helper.fetch_medal_tally(df, selected_year, selected_country, 'Winter')
    ...
    if user_menu == 'Athlete wise Analysis':
        ...
        famous_sport = ['Speed Skating', 'Cross Country Skiing', 'Ice Hockey', 'Biathlon', 'Alpine Skiing', 'Luge',
                        'Bobsleigh', 'Figure Skating',
                        'Nordic Combined', 'Alpinism', 'Military Ski Patrol', 'Skeleton', 'Ski Jumping',
                        'Freestyle Skiing', 'Curling', 'Snowboarding', 'Short Track Speed Skating']
        ...
        temp_df = helper.weight_v_height(df, selected_sport)
        fig, ax = plt.pyplot.subplots(figsize=(20, 20))
        ax = sns.scatterplot(data=temp_df, x=temp_df['Weight'], y=temp_df['Height'])
        st.pyplot(fig)
